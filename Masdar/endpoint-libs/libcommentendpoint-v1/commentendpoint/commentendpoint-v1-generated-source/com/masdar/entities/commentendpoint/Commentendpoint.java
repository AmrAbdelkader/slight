...
package com.masdar.entities.commentendpoint;
...
public class Commentendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.16.0-rc of the commentendpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class GetComment extends CommentendpointRequest<com.masdar.entities.commentendpoint.model.Comment> {
    ...
    protected GetComment(java.lang.Long id) {
      super(Commentendpoint.this, "GET", REST_PATH, null, com.masdar.entities.commentendpoint.model.Comment.class);
  ...
  /**
   * Create a request for the method "getCommentByIdeaId".
   *
   * This request holds the parameters needed by the the commentendpoint server.  After setting any
   * optional parameters, call the {@link GetCommentByIdeaId#execute()} method to invoke the remote
   * operation.
   *
   * @param ideaId
   * @return the request
   */
  public GetCommentByIdeaId getCommentByIdeaId(java.lang.Long ideaId) throws java.io.IOException {
    GetCommentByIdeaId result = new GetCommentByIdeaId(ideaId);
    initialize(result);
    return result;
  }

  public class GetCommentByIdeaId extends CommentendpointRequest<com.masdar.entities.commentendpoint.model.CollectionResponseComment> {

    private static final String REST_PATH = "collectionresponse_comment/{ideaId}";
     ...
     * This request holds the parameters needed by the the commentendpoint server.  After setting any
     * optional parameters, call the {@link GetCommentByIdeaId#execute()} method to invoke the remote
     * operation. <p> {@link GetCommentByIdeaId#initialize(com.google.api.client.googleapis.services.A
     ...
     * @since 1.13
     */
    protected GetCommentByIdeaId(java.lang.Long ideaId) {
      super(Commentendpoint.this, "GET", REST_PATH, null, com.masdar.entities.commentendpoint.model.CollectionResponseComment.class);
    ...
    @Override
    public GetCommentByIdeaId setAlt(java.lang.String alt) {
      return (GetCommentByIdeaId) super.setAlt(alt);
    }

    @Override
    public GetCommentByIdeaId setFields(java.lang.String fields) {
      return (GetCommentByIdeaId) super.setFields(fields);
    }

    @Override
    public GetCommentByIdeaId setKey(java.lang.String key) {
      return (GetCommentByIdeaId) super.setKey(key);
    }

    @Override
    public GetCommentByIdeaId setOauthToken(java.lang.String oauthToken) {
      return (GetCommentByIdeaId) super.setOauthToken(oauthToken);
    }

    @Override
    public GetCommentByIdeaId setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetCommentByIdeaId) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetCommentByIdeaId setQuotaUser(java.lang.String quotaUser) {
      return (GetCommentByIdeaId) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetCommentByIdeaId setUserIp(java.lang.String userIp) {
      return (GetCommentByIdeaId) super.setUserIp(userIp);
    }
    ...
    public GetCommentByIdeaId setIdeaId(java.lang.Long ideaId) {
      this.ideaId = ideaId;
      return this;
    }
    ...
    public GetCommentByIdeaId setCursor(java.lang.String cursor) {
      this.cursor = cursor;
      return this;
    }
    ...
    public GetCommentByIdeaId setLimit(java.lang.Integer limit) {
      this.limit = limit;
      return this;
    }

    @Override
    public GetCommentByIdeaId set(String parameterName, Object value) {
      return (GetCommentByIdeaId) super.set(parameterName, value);
    }
  }
   ...
   * operation.
   *
   * @param content the {@link com.masdar.entities.commentendpoint.model.Comment}
   * @return the request
   */
  public InsertComment insertComment(com.masdar.entities.commentendpoint.model.Comment content) throws java.io.IOException {
    InsertComment result = new InsertComment(content);
    initialize(result);
    return result;
  }

  public class InsertComment extends CommentendpointRequest<com.masdar.entities.commentendpoint.model.Comment> {
     ...
     * @since 1.13
     */
    protected InsertComment(com.masdar.entities.commentendpoint.model.Comment content) {
      super(Commentendpoint.this, "POST", REST_PATH, content, com.masdar.entities.commentendpoint.model.Comment.class);
    }
  ...
  public class ListComment extends CommentendpointRequest<com.masdar.entities.commentendpoint.model.CollectionResponseComment> {
   ...
   * @return the request
   */
  public UpdateComment updateComment(com.masdar.entities.commentendpoint.model.Comment content) throws java.io.IOException {
    UpdateComment result = new UpdateComment(content);
    initialize(result);
    return result;
  }

  public class UpdateComment extends CommentendpointRequest<com.masdar.entities.commentendpoint.model.Comment> {
     ...
     * @since 1.13
     */
    protected UpdateComment(com.masdar.entities.commentendpoint.model.Comment content) {
      super(Commentendpoint.this, "PUT", REST_PATH, content, com.masdar.entities.commentendpoint.model.Comment.class);
    }
