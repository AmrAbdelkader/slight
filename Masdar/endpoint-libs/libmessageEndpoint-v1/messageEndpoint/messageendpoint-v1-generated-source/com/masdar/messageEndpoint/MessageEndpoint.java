 ...
 * on 2014-01-13 at 01:52:26 UTC 
 * Modify at your own risk.
 */

package com.masdar.messageEndpoint;
...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListMessages extends MessageEndpointRequest<com.masdar.messageEndpoint.model.CollectionResponseMessageData> {
    ...
    protected ListMessages() {
      super(MessageEndpoint.this, "GET", REST_PATH, null, com.masdar.messageEndpoint.model.CollectionResponseMessageData.class);
    }
  ...
  /**
   * Create a request for the method "sendMessageToDevice".
   *
   * This request holds the parameters needed by the the messageEndpoint server.  After setting any
   * optional parameters, call the {@link SendMessageToDevice#execute()} method to invoke the remote
   * operation.
   *
   * @param message
   * @param deviceId
   * @return the request
   */
  public SendMessageToDevice sendMessageToDevice(java.lang.String message, java.lang.String deviceId) throws java.io.IOException {
    SendMessageToDevice result = new SendMessageToDevice(message, deviceId);
    initialize(result);
    return result;
  }

  public class SendMessageToDevice extends MessageEndpointRequest<Void> {

    private static final String REST_PATH = "sendMessageToDevice/{message}/{deviceId}";
     ...
     * This request holds the parameters needed by the the messageEndpoint server.  After setting any
     * optional parameters, call the {@link SendMessageToDevice#execute()} method to invoke the remote
     * operation. <p> {@link SendMessageToDevice#initialize(com.google.api.client.googleapis.services.
     ...
     * @since 1.13
     */
    protected SendMessageToDevice(java.lang.String message, java.lang.String deviceId) {
      super(MessageEndpoint.this, "POST", REST_PATH, null, Void.class);
      this.message = com.google.api.client.util.Preconditions.checkNotNull(message, "Required parameter message must be specified.");
    ...
    @Override
    public SendMessageToDevice setAlt(java.lang.String alt) {
      return (SendMessageToDevice) super.setAlt(alt);
    }

    @Override
    public SendMessageToDevice setFields(java.lang.String fields) {
      return (SendMessageToDevice) super.setFields(fields);
    }

    @Override
    public SendMessageToDevice setKey(java.lang.String key) {
      return (SendMessageToDevice) super.setKey(key);
    }

    @Override
    public SendMessageToDevice setOauthToken(java.lang.String oauthToken) {
      return (SendMessageToDevice) super.setOauthToken(oauthToken);
    }

    @Override
    public SendMessageToDevice setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SendMessageToDevice) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SendMessageToDevice setQuotaUser(java.lang.String quotaUser) {
      return (SendMessageToDevice) super.setQuotaUser(quotaUser);
    }

    @Override
    public SendMessageToDevice setUserIp(java.lang.String userIp) {
      return (SendMessageToDevice) super.setUserIp(userIp);
    }
    ...
    public SendMessageToDevice setMessage(java.lang.String message) {
      this.message = message;
      return this;
    }
    ...
    public SendMessageToDevice setDeviceId(java.lang.String deviceId) {
      this.deviceId = deviceId;
      return this;
    }

    @Override
    public SendMessageToDevice set(String parameterName, Object value) {
      return (SendMessageToDevice) super.set(parameterName, value);
    }
  }
