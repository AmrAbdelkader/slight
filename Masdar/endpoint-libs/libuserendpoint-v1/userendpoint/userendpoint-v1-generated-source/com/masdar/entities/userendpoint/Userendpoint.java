...
package com.masdar.entities.userendpoint;
...
public class Userendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getFollowingByUser".
   *
   * This request holds the parameters needed by the the userendpoint server.  After setting any
   * optional parameters, call the {@link GetFollowingByUser#execute()} method to invoke the remote
   * operation.
   *
   * @param userId
   * @return the request
   */
  public GetFollowingByUser getFollowingByUser(java.lang.Long userId) throws java.io.IOException {
    GetFollowingByUser result = new GetFollowingByUser(userId);
    initialize(result);
    return result;
  }

  public class GetFollowingByUser extends UserendpointRequest<com.masdar.entities.userendpoint.model.CollectionResponseUser> {

    private static final String REST_PATH = "collectionresponse_user/{userId}";
     ...
     * This request holds the parameters needed by the the userendpoint server.  After setting any
     * optional parameters, call the {@link GetFollowingByUser#execute()} method to invoke the remote
     * operation. <p> {@link GetFollowingByUser#initialize(com.google.api.client.googleapis.services.A
     ...
     * @since 1.13
     */
    protected GetFollowingByUser(java.lang.Long userId) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.masdar.entities.userendpoint.model.CollectionResponseUser.class);
    ...
    @Override
    public GetFollowingByUser setAlt(java.lang.String alt) {
      return (GetFollowingByUser) super.setAlt(alt);
    }

    @Override
    public GetFollowingByUser setFields(java.lang.String fields) {
      return (GetFollowingByUser) super.setFields(fields);
    }

    @Override
    public GetFollowingByUser setKey(java.lang.String key) {
      return (GetFollowingByUser) super.setKey(key);
    }

    @Override
    public GetFollowingByUser setOauthToken(java.lang.String oauthToken) {
      return (GetFollowingByUser) super.setOauthToken(oauthToken);
    }

    @Override
    public GetFollowingByUser setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetFollowingByUser) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetFollowingByUser setQuotaUser(java.lang.String quotaUser) {
      return (GetFollowingByUser) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetFollowingByUser setUserIp(java.lang.String userIp) {
      return (GetFollowingByUser) super.setUserIp(userIp);
    }
    ...
    public GetFollowingByUser setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }
    ...
    public GetFollowingByUser setCursor(java.lang.String cursor) {
      this.cursor = cursor;
      return this;
    }
    ...
    public GetFollowingByUser setLimit(java.lang.Integer limit) {
      this.limit = limit;
      return this;
    }

    @Override
    public GetFollowingByUser set(String parameterName, Object value) {
      return (GetFollowingByUser) super.set(parameterName, value);
    }
  }

  /**
   * Create a request for the method "getSocialIdeaUsers".
   *
   * This request holds the parameters needed by the the userendpoint server.  After setting any
   * optional parameters, call the {@link GetSocialIdeaUsers#execute()} method to invoke the remote
   * operation.
   *
   * @param ideaId
   * @return the request
   */
  public GetSocialIdeaUsers getSocialIdeaUsers(java.lang.Long ideaId) throws java.io.IOException {
    GetSocialIdeaUsers result = new GetSocialIdeaUsers(ideaId);
    initialize(result);
    return result;
  }

  public class GetSocialIdeaUsers extends UserendpointRequest<com.masdar.entities.userendpoint.model.CollectionResponseUser> {

    private static final String REST_PATH = "getSocialIdeaUsers";
     ...
     * This request holds the parameters needed by the the userendpoint server.  After setting any
     * optional parameters, call the {@link GetSocialIdeaUsers#execute()} method to invoke the remote
     * operation. <p> {@link GetSocialIdeaUsers#initialize(com.google.api.client.googleapis.services.A
     * bstractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @param ideaId
     * @since 1.13
     */
    protected GetSocialIdeaUsers(java.lang.Long ideaId) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.masdar.entities.userendpoint.model.CollectionResponseUser.class);
    ...
    @Override
    public GetSocialIdeaUsers setAlt(java.lang.String alt) {
      return (GetSocialIdeaUsers) super.setAlt(alt);
    }

    @Override
    public GetSocialIdeaUsers setFields(java.lang.String fields) {
      return (GetSocialIdeaUsers) super.setFields(fields);
    }

    @Override
    public GetSocialIdeaUsers setKey(java.lang.String key) {
      return (GetSocialIdeaUsers) super.setKey(key);
    }

    @Override
    public GetSocialIdeaUsers setOauthToken(java.lang.String oauthToken) {
      return (GetSocialIdeaUsers) super.setOauthToken(oauthToken);
    }

    @Override
    public GetSocialIdeaUsers setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetSocialIdeaUsers) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetSocialIdeaUsers setQuotaUser(java.lang.String quotaUser) {
      return (GetSocialIdeaUsers) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetSocialIdeaUsers setUserIp(java.lang.String userIp) {
      return (GetSocialIdeaUsers) super.setUserIp(userIp);
    }
    ...
    public GetSocialIdeaUsers setIdeaId(java.lang.Long ideaId) {
      this.ideaId = ideaId;
      return this;
    }

    @Override
    public GetSocialIdeaUsers set(String parameterName, Object value) {
      return (GetSocialIdeaUsers) super.set(parameterName, value);
    }
  }
  ...
  public class GetUser extends UserendpointRequest<com.masdar.entities.userendpoint.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(Userendpoint.this, "GET", REST_PATH, null, com.masdar.entities.userendpoint.model.User.class);
   ...
   *
   * @param content the {@link com.masdar.entities.userendpoint.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.masdar.entities.userendpoint.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserendpointRequest<com.masdar.entities.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.masdar.entities.userendpoint.model.User content) {
      super(Userendpoint.this, "POST", REST_PATH, content, com.masdar.entities.userendpoint.model.User.class);
    }
  ...
  public class ListUser extends UserendpointRequest<com.masdar.entities.userendpoint.model.CollectionResponseUser> {
   ...
   * @return the request
   */
  public UpdateUser updateUser(com.masdar.entities.userendpoint.model.User content) throws java.io.IOException {
    UpdateUser result = new UpdateUser(content);
    initialize(result);
    return result;
  }

  public class UpdateUser extends UserendpointRequest<com.masdar.entities.userendpoint.model.User> {
     ...
     * @since 1.13
     */
    protected UpdateUser(com.masdar.entities.userendpoint.model.User content) {
      super(Userendpoint.this, "PUT", REST_PATH, content, com.masdar.entities.userendpoint.model.User.class);
    }
