...
import com.masdar.deviceinfoendpoint.Deviceinfoendpoint;
import com.masdar.deviceinfoendpoint.model.DeviceInfo;
...
public class GCMIntentService extends GCMBaseIntentService {
   ...
   * information.
   */
  protected static final String PROJECT_NUMBER = "966286397243";
      ...
      if (!alreadyRegisteredWithEndpointServer) {
        ...
        endpoint.insertDeviceInfo(
            deviceInfo
                ...
                //.setDeviceInformation(URLEncoder.encode(android.os.Build.MANUFACTURER+ " "+ android.os.Build.PRODUCT,"UTF-8")))
                .setDeviceInformation(MasdarUtil.getDeviceId(getApplicationContext())))
                .execute();
      }
    } catch (IOException e) {
...
//                + endpoint.getRootUrl() + "."
//                + "See your Android log for more information.",true, true);
        return;
      }
    }
